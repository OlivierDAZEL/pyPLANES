...
print(f"GM={global_method.result.R0}")
...
print(f"RM={recursive_method.result.R0}")

characteristic_method = PwProblem(ml=ml, name_project=name_project, theta_d=theta_d, frequencies=frequency, plot_solution=plot_solution,termination=termination, method="characteristic", verbose=verbose,save_append="a", print_result=True)
recursive_method.resolution()
print(f"RM={recursive_method.result.R0}")



# caracteristic_method = PwProblem(ml=ml, name_project=name_project, theta_d=theta_d, frequencies=frequency, plot_solution=plot_solution,termination=termination, method="characteristics", verbose=verbose,save_append="a", print_result=True)
