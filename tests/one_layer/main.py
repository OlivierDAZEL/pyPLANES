...
# from pyPLANES.utils.utils_PW import Solver_PW
from pyPLANES.pw.problem.pw_classes import PwProblem
...
S_PW = PwProblem(ml=ml, name_project=name_project, theta_d=theta_d, frequencies=frequencies, plot_results=plot_results)
