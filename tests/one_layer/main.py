...
fem = PeriodicFemProblem(name_project=name_project, name_mesh=name_project, order=5, theta_d=theta_d, frequencies=frequencies, plot_solution=plot_solution,termination=termination, verbose=False)
fem.resolution()
